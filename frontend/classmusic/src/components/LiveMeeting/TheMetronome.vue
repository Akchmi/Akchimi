<template>
	<div class="metronome-container">
		<h3>Metronome</h3>
		<h1>{{ nowBpm }} BPM</h1>
		<input class="bpm-input" type="range" id="bpm" min="40" max="220" v-model="nowBpm" />
		...
		<div
			ref="metronome"
			:class="this.side == 0 ? 'metronome is-playing-right' : 'metronome is-playing-left'"
		>
			<div ref="blink" class="metronome__blink"></div>
			<div class="metronome__viz">
				<div class="metronome__line"></div>
				<div ref="indicator" :style="cssVariable" class="metronome__indicator"></div>
			</div>
		</div>
	</div>
</template>
